...
//            document.id(document).addEvent('keydown', designer.keyEventHandler.bindWithEvent(designer));
            ...
            if (!isTryMode)
            {
                ...
                window.onbeforeunload = functionconfirmExit()
                {
                    if (designer.needsSave())
                    {
...
var fireNativeEvent = function(type, target, position) {
    ...
    if (Browser.ie) {
        ...
        var eventFamily;
        if (type == "click" || type == "mousedown" || type == "mousemove" || type == "mouseout" || type == "mouseover" || type == "mouseup" || type == "dblclick") {
            eventFamily = "MouseEvents";
        } else if (type == "keydown" || type == "keypress" || type == "keyup" || type=="DOMActivate" || type == "DOMFocusIn" || type == "DOMFocusOut") {
            eventFamily = "UIEvents";
        } else if (type == "abort" || type == "blur" || type == "change" || type == "error" || type == "focus" || type == "load" || type == "reset" || type == "resize" || type == "scroll" || type == "select" || type == "submit" || type == "unload") {
            eventFamily = "HTMLEvents";
        } else if(type == "DOMAttrModified"  || type == "DOMNodeInserted" || type == "DOMNodeRemoved" || type == "DOMCharacterDataModified" || type == "DOMNodeInsertedIntoDocument"  || type == "DOMNodeRemovedFromDocument" || type == "DOMSubtreeModified") {
